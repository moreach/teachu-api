...
public class LogRecord extends UpdatableRecordImpl<LogRecord> implements Record5<UUID, String, String, LogLevel, LocalDateTime> {

    private static final long serialVersionUID = -1984603317;
    ...
    @Override
    public Row5<UUID, String, String, LogLevel, LocalDateTime> valuesRow() {
    ...
    @Override
    public LogRecord value4(LogLevel value) {
        setLevel(value);
        return this;
    }
    ...
    @Override
    public LogRecord values(UUID value1, String value2, String value3, LogLevel value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogRecord(UUID id, String message, String origin, LogLevel level, LocalDateTime timestamp) {
        super(Log.LOG);
