...
public class ExamRecord extends UpdatableRecordImpl<ExamRecord> implements Record8<UUID, UUID, String, String, Double, LocalDate, LocalDate, UUID> {

    private static final long serialVersionUID = -1865431873;
    ...
    /**
     * Setter for <code>teachu.exam.semester_id</code>.
     */
    ...
    /**
     * Getter for <code>teachu.exam.semester_id</code>.
     */
    ...
    @Override
    public Row8<UUID, UUID, String, String, Double, LocalDate, LocalDate, UUID> valuesRow() {
    ...
    @Override
    public ExamRecord value8(UUID value) {
        setSemesterId(value);
        return this;
    }

    @Override
    public ExamRecord values(UUID value1, UUID value2, String value3, String value4, Double value5, LocalDate value6, LocalDate value7, UUID value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExamRecord(UUID id, UUID schoolClassSubjectId, String name, String description, Double weight, LocalDate date, LocalDate viewDate, UUID semesterId) {
        super(Exam.EXAM);
