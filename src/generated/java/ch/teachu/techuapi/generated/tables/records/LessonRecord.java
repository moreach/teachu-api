...
public class LessonRecord extends UpdatableRecordImpl<LessonRecord> implements Record6<UUID, UUID, LocalTime, LocalTime, String, byte[]> {
    ...
    private static final long serialVersionUID = 946710665;
    ...
    /**
     * Setter for <code>teachu.lesson.class_subject_id</code>.
     */
    ...
    /**
     * Getter for <code>teachu.lesson.class_subject_id</code>.
     */
    ...
    public Field<UUID> field2() {
        return Lesson.LESSON.CLASS_SUBJECT_ID;
    }
     ...
     */
    public LessonRecord(UUID id, UUID classSubjectId, LocalTime startTime, LocalTime endTime, String weekday, byte[] room) {
        super(Lesson.LESSON);

        set(0, id);
        set(1, classSubjectId);
        set(2, startTime);
        set(3, endTime);
        set(4, weekday);
        set(5, room);
